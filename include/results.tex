...
\todo{explain that we want to find a wdt threshold value}
...
parameters.\todo{explanation of fast/slow group numbering}
...
understood.\todo{explanation of importance of other two values}
...
\label{sec:pwr}\todo{replace instances of fast/slow with 1/2}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{cc} Group 1 ($E > 0.0625$) & Group 2 \\
    \input{include/tables/fast_inf_flx_grp_1}
 &
   \input{include/tables/fast_inf_flx_grp_2}
  \end{tabular}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{cc} Group 1 ($E > 0.0625$) & Group 2 \\
    \input{include/tables/fast_inf_tot_grp_1}
 &
   \input{include/tables/fast_inf_tot_grp_2}
  \end{tabular}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{cc} $\Sigma_{1\to 1}$ & $\Sigma_{2 \to 1}$ \\
\input{include/tables/fast_inf_sp0_grp_1} & 
\input{include/tables/fast_inf_sp0_grp_2} \\
$\Sigma_{1\to 2}$ & $\Sigma_{2 \to 2}$ \\
\input{include/tables/fast_inf_sp0_grp_3} & 
\input{include/tables/fast_inf_sp0_grp_4} 
  \end{tabular}
...
variance. \todo{citation needed} The variance for summing energy groups $g$ to $g'$ is therefore:
\begin{equation*}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{cc} Fast Group ($E > 0.0625$) & Slow Group \\
    \input{include/tables/homog_inf_flx_grp_comb1}
 &
   \input{include/tables/homog_inf_flx_grp_comb2}
  \end{tabular}
...
\begin{table}[hbtp]
  ...
  \begin{tabular}{cc} Fast group ($E > 0.0625$) & Slow group \\
    \input{include/tables/homog_inf_tot_grp_comb1}
 &
   \input{include/tables/homog_inf_tot_grp_comb2}
  \end{tabular}
...
\input{include/tables/homog_inf_sp0_grp_comb1} & 
\input{include/tables/homog_inf_sp0_grp_comb2} \\
$\Sigma_{f\to s}$ & $\Sigma_{s \to s}$ \\
\input{include/tables/homog_inf_sp0_grp_comb3} & 
\input{include/tables/homog_inf_sp0_grp_comb4} 
  \end{tabular}
