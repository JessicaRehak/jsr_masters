...
\begin{figure}[hbt]
  ...
  \label{fig:sigma_maj}
\end{figure}
% should y axis be \Sigma_{t} for clarity?
...
%incomplete sentence and paragraph...
\begin{lstlisting}
a = [];                     % Accepted samples
for i = 1:1000
    x = rand;               % Sample g(x)
...
given boundary. 
% I'd add a sentence about why this is important--make us see that this is a thing it is
...
% May want to elaborate on all of this, but it'll likely change given previous comment. 
